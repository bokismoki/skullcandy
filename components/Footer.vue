<template>
  <footer class="bg-black text-white">
    <div class="px-3 py-10">
      ...
      <div>
        <div class="mt-10">
          <h1 class="text-center text-sm font-semibold">FOLLOW US</h1>
        ...
        <div class="mt-10">
          <ul>
            <li
              class="flex flex-col cursor-pointer border-t-2 p-3 border-gray-700"
        ...
        <div class="mt-10">
          <h1 class="text-center text-sm font-semibold uppercase">Subscribe to our podcast</h1>
          <div class="flex items-center justify-center mt-3">
